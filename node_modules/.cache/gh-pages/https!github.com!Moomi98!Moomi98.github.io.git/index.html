...
/static/a0cbe2a1fab7acd71d5b706488abd87f/3bd3e/profile.jpg 1.5x,
/static/a0cbe2a1fab7acd71d5b706488abd87f/9d183/profile.jpg 2x" src="/static/a0cbe2a1fab7acd71d5b706488abd87f/3e51d/profile.jpg" alt="Moomi" style="position:absolute;top:0;left:0;opacity:1;width:100%;height:100%;object-fit:cover;object-position:center"/></picture></noscript></div><div class="author-name"><span class="author-name-prefix">안녕하세요. 프론트엔드 개발자 김정현 입니다 👋</span><a class="author-name-content" href="/about"><span>@<!-- -->Moomi</span></a><div class="author-introduction">어제보다 더 나은 내가 되자 </div><p class="author-socials"><a href="https://github.com//Moomi98"><img src="/github.png" style="width:30px;height:30px;padding:3px"/></a></p></div></div></div></div><ul class="category-container" role="tablist" id="category" style="margin:0 -1.21875rem"><li class="item" role="tab" aria-selected="true"><div>All</div></li><li class="item" role="tab" aria-selected="false"><div>javascript</div></li><li class="item" role="tab" aria-selected="false"><div>Javascript</div></li><li class="item" role="tab" aria-selected="false"><div>cloud service</div></li><li class="item" role="tab" aria-selected="false"><div>dev</div></li><li class="item" role="tab" aria-selected="false"><div>React</div></li></ul><div class="thumbnail-container"><a class="thumbnail observed" href="/Javascript/실행-컨텍스트/"><div><h3>실행 컨텍스트</h3><p>💻 정의 실행 컨텍스트는 소스코드를 실행하는데 필요한 환경을 제공하고 코드의 실행 결과를 실제로 관리하는 영역이다. 구체적으로, 실행 컨텍스트는 식별자를 등록하는 관리한는 스코프와 코드 실행 순서 관리를 구현한 내부 매커니즘으로, 모든 코드는 실행 컨텍스트를 통해 실행되고 관리된다. 식별자와 스코프는 실행 컨텍스트의 LexicalEnvironment로 관…</p></div></a><a class="thumbnail observed" href="/Javascript/Javascript에서의-this/"><div><h3>Javascript에서의 this</h3><p>💻 정의 this는 자신이 속한 객체 또는 자신이 생성할 인스턴스를 가리키는 자기 참조 변수다. this를 통해 자신이 속한 객체 또는 생성할 인스턴스의 프로퍼티나 메소드를 참조할 수 있다. this는 자바스크립트 엔진에 의해 암묵적으로 생성되며, 코드 어디서든 참조할 수 있다. 또한 this는 함수 호출 방식에 의해 동적으로 결정될 수 있다. 📍 함수 …</p></div></a><a class="thumbnail observed" href="/cloud service/linux-명령어-2/"><div><h3>linux 명령어 2</h3><p>🚗 절대경로와 상대경로 절대경로 : root부터 현재 디렉토리까지의 고정된 경로를 표현 상대경로 : 현재 위치한 곳을 기준으로 해서 해당 디렉토리의 위치를 표현 패키지 다운로드 apt-get : root 권한이 있어야만 사용 가능 -> sudo 명령어로 root 권한을 잠시 빌릴 수 있음 패스워드 설정  유저 변경  root로 변경 => 
다시 일반 유저…</p></div></a><a class="thumbnail observed" href="/dev/react-cookie-적용기/"><div><h3>React-cookie 적용기</h3><p>졸업작품을 진행하던 중 사용자 정보를 다른 페이지에서 활용할 일들이 생겨 방법을 고민해봤다. 우선 기존에는 Redux를 이용하여 사용자가 로그인을 완료하면 Redux에 저장한 후 그 데이터를 활용하려 했다. 그러나, 이 방법의 심각한 문제점은 새로고침을 하면 Redux의 정보가 모두 날아간다는 것이었다. 따라서 사용자 정보를 로컬 브라우저에 담아야 했고,…</p></div></a><a class="thumbnail observed" href="/React/usestate-동작-원리/"><div><h3>useState 동작 원리</h3><p>📝 이 글을 쓰게 된 이유 react에서 제공하는 hook은 웹페이지를 구현하는데 정말 많은 편리함을 가져다준다. 그중에서도 는 state값에 따른 조건부 렌더링, state에 따른 로직 처리 등 정말 다양한 곳에서 사용되고 있는데, useState를 사용하면서 많은 React 입문자들이 겪었을 의문점을 나도 가지게 되었다. setState 함수로 갱신한…</p></div></a><a class="thumbnail observed" href="/cloud service/linux-명렁어-1/"><div><h3>Linux 명렁어 1</h3><p>📃 Ubuntu란 💡 리눅스 커널을 기반으로 한 리눅스 배포판 중 하나.
따라서 우분투와 리눅스는 계층 구조가 같다. 최상단에 root 디렉토리가 위치하고 밑에 bin, etc, usr, boot, home 디렉토리가 위치한다. 🔍 명령어 값 의미 사용 방법  현재 작업 디렉토리 확인 pwd  현재 디렉토리 내의 파일 확인 ls  새 디렉토리 생성 mkd…</p></div></a></div><footer class="footer">©<a href="https://github.com/JaeYeopHan">Jbee</a>, Built with<!-- --> <a href="https://github.com/JaeYeopHan/gatsby-starter-bee">Gatsby-starter-bee</a></footer></div></div><div id="gatsby-announcer" style="position:absolute;top:0;width:1px;height:1px;padding:0;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0" aria-live="assertive" aria-atomic="true"></div></div><script id="gatsby-script-loader">/*<![CDATA[*/window.pagePath="/";/*]]>*/</script><script id="gatsby-chunk-mapping">/*<![CDATA[*/window.___chunkMapping={"polyfill":["/polyfill-c5f50f2ad13861331c8a.js"],"app":["/app-3c05c8cc529f53d7942d.js"],"component---node-modules-gatsby-plugin-offline-app-shell-js":["/component---node-modules-gatsby-plugin-offline-app-shell-js-15096bed533ed0ff8b58.js"],"component---src-pages-404-js":["/component---src-pages-404-js-64b4b10bec6f94406ee7.js"],"component---src-pages-about-js":["/component---src-pages-about-js-7c98c55521c7b23b4710.js"],"component---src-pages-index-js":["/component---src-pages-index-js-3694d86bd2296fc931a7.js"],"component---src-templates-blog-post-js":["/component---src-templates-blog-post-js-1b5f810c2b47cf05299f.js"]};/*]]>*/</script><script src="/polyfill-c5f50f2ad13861331c8a.js" nomodule=""></script><script src="/component---src-pages-index-js-3694d86bd2296fc931a7.js" async=""></script><script src="/cd7d5f864fc9e15ed8adef086269b0aeff617554-ad5f5a9f7bb5389a74c0.js" async=""></script><script src="/d5d7a013bc6c1e2b6d7db819052c16d7efea5559-9f1b54023581f57f7f44.js" async=""></script><script src="/133dca110fad53aa1997b630637bbac3134a2d14-b9d424b4c6bbcac9907c.js" async=""></script><script src="/styles-e9d24b1846c7d6eb9685.js" async=""></script><script src="/app-3c05c8cc529f53d7942d.js" async=""></script><script src="/framework-9252bfa5ea71b588207d.js" async=""></script><script src="/webpack-runtime-a12cc4fdc9d404ab78e8.js" async=""></script></body></html>